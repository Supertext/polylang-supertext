...
class Core
{
  ...
  public function registerLocalizationScripts()
  {
    $translation_array = array(
      ...
      'errorValidationSomePostInTranslation' => esc_js(__('Posts in translation cannot be translated. Please use the original article to order a translation.', 'polylang-supertext')),
