<script type="text/html" id="tmpl-sttr-shortcode-setting">
  <div class="shortcode-setting-container">
    ...
    <div class="shortcode-setting-part shortcode-setting-part-attributes">
      <div class="shortcode-setting-title">
        <?php _e('Translatable attributes', 'supertext'); ?>
      </div>
      <div class="shortcode-setting-attributes">

      </div>
      <button type="button" class="button button-highlighted button-add shortcode-attribute-add-input"><?php _e('Add attribute', 'supertext'); ?></button>
    </div>
    <div class="clear"></div>
    <button type="button" class="button button-highlighted button-remove shortcode-remove-setting"><span class="dashicons dashicons-trash"></span> <?php _e('remove setting', 'supertext'); ?></button>
  </div>
</script>
