...
You can create an account at [Supertext](https://www.supertext.com/person/de/account/signin) if you don't already have one.
...
= 4.26 =
* Update service type ID to use new translation services
* Logo update
...
= 4.09 =
* Add basic support for ACF Gutenberg blocks that contain text in the data object.

= 4.08 =
* Suppress warnings generated by DOMDocument::loadHTML()
* Fix ordering bug when blog name is longer than 50 characters
